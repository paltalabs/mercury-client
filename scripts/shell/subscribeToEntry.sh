curl -X POST http://ec2-16-170-242-7.eu-north-1.compute.amazonaws.com:3030/entry \
     ...
     -d '{"contract_id": "CAXROB2BP7SIIEHPD52NQKUXFD7M7OTNYNWGXB47AUYEUAUDC6V4F357", "max_single_size": 64000}'
